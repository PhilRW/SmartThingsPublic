/**
*  All-Season Fan Temperature + Occupancy Controller
*
...
*/
definition(
    name: "All-Season Fan Temperature + Occupancy Controller",
    namespace: "PhilRW",
    author: "Philip Rosenberg-Watt",
    description: "Sets fan speed based on temperature and (optionally) motion. Winter mode triggers low speed on motion for 24 hours.",
    category: "My Apps",
